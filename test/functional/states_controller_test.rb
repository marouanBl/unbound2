...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { continents_id: @state.continents_id, countries_id: @state.countries_id, name: @state.name }
    end
  ...
  test "should update state" do
    put :update, id: @state, state: { continents_id: @state.continents_id, countries_id: @state.countries_id, name: @state.name }
    assert_redirected_to state_path(assigns(:state))
  end
